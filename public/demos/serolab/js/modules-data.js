/* ============================================================
   BRAIN BRANDING - CATÁLOGO EXTENDIDO DE MÓDULOS, IA & SUBMÓDULOS v2.2
   ============================================================ */
...
const SEROLAB_MODULES = [
  // EJE 1: RECEPCIÓN Y COMERCIAL
  {
    ...
    category: "recepcion",
    name: "1. Solicitud de Exámenes (Admisión)",
    icon: "📋",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "carga_masiva",
    category: "recepcion",
    name: "2. Carga Masiva de Solicitudes (XLS)",
    icon: "📑",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "cotizaciones",
    category: "recepcion",
    name: "3. Cotizaciones y Presupuestos",
    icon: "🏷️",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "convenios",
    category: "recepcion",
    name: "4. Convenios Corporativos y Empresas",
    icon: "🤝",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "crm_medico",
    category: "recepcion",
    name: "5. CRM Médico & Pipeline Comercial",
    icon: "📈",
    badgeType: "new",
  ...
  // EJE 2: LIMS OPERATIVO Y ESTUDIOS
  {
    id: "estudios",
    category: "lims",
    name: "6. Catálogo de Estudios y Perfiles",
    icon: "🧪",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    ...
    category: "lims",
    name: "7. Entregas, Validación y Resultados",
    icon: "🖨️",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "portal_pacientes",
    category: "lims",
    name: "8. Portal Web & Móvil de Pacientes",
    icon: "📱",
    badgeType: "new",
    badgeText: "⚡ 100% Nuevo de Brain Branding (No existe en Labtivity)",
  ...
  },
  {
    id: "doctores",
    category: "lims",
    name: "9. Directorio y Portal de Doctores",
    icon: "👨‍⚕️",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "lista_precios",
    category: "lims",
    name: "10. Listas de Precios y Tarifarios",
    icon: "💲",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  // EJE 3: FACTURACIÓN Y FINANZAS
  {
    id: "corte_caja",
    category: "finanzas",
    name: "11. Corte de Caja y Turnos (POS)",
    icon: "💰",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "facturacion_cfdi",
    category: "finanzas",
    name: "12. Facturación CFDI 4.0 & Autofacturación",
    icon: "🧾",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "cuentas_cobrar",
    category: "finanzas",
    name: "13. Cuentas por Cobrar (CxC)",
    icon: "📊",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  },
  {
    id: "notas_credito",
    category: "finanzas",
    name: "14. Notas de Crédito y Devoluciones",
    icon: "🔄",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
  ...
  // EJE 4: ERP, CONTABILIDAD Y GESTIÓN
  {
    id: "contabilidad_sat",
    category: "erp",
    name: "15. Contabilidad Electrónica Integrada SAT",
    icon: "📚",
    badgeType: "new",
    badgeText: "⚡ 100% Nuevo de Brain Branding (No existe en Labtivity)",
  ...
  },
  {
    ...
    category: "erp",
    name: "16. Estado de Resultados (P&L) en Vivo",
    icon: "📉",
    badgeType: "new",
    badgeText: "⚡ 100% Nuevo de Brain Branding (No existe en Labtivity)",
  ...
  },
  {
    ...
    category: "erp",
    name: "17. ERP: Compras e Inventario de Reactivos",
    icon: "📦",
    badgeType: "new",
    badgeText: "⚡ 100% Nuevo de Brain Branding (No existe en Labtivity)",
  ...
  },
  {
    id: "informes_bi",
    category: "erp",
    name: "18. Informes Ejecutivos & BI",
    icon: "📊",
    badgeType: "legacy",
    badgeText: "🔴 Ya existe en Labtivity (Lo Mejoraremos)",
