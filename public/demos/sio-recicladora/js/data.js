...
const initialData = {
  ...
  materials: [
    ...
    {
      id: "MAT-04",
      name: "Aluminio Perfil / Estructural Limpio",
      category: "No Ferrosos",
      unit: "kg",
      buyerPrice: 38.50,
      t1Price: 27.72,
    ...
    {
      id: "MAT-05",
      name: "Aluminio Bote / Lata Prensada",
      category: "No Ferrosos",
      unit: "kg",
      buyerPrice: 29.00,
      t1Price: 20.88,
    ...
    {
      id: "MAT-06",
      name: "Bronce Amarillo / Valvulería",
      category: "No Ferrosos",
      unit: "kg",
      buyerPrice: 96.00,
      t1Price: 69.12,
    ...
    {
      id: "MAT-07",
      name: "Baterías Automotrices Ácido-Plomo (Casco)",
      category: "Especiales",
      unit: "kg",
      buyerPrice: 18.50,
      t1Price: 13.32,
    ...
    },
    {
      ...
      icon: "⚙️",
      colorTag: "#94a3b8",
      intlBenchmark: "LME-NI"
    }
  ],

  suppliers: [
    { id: "SUP-01", name: "Don Juan Martínez (Triciclo)", tier: "T1", phone: "664-555-0192", city: "Otay, Tijuana" },
    { id: "SUP-02", name: "Transportes y Fletes El Rayo", tier: "T2", phone: "664-555-0381", city: "Mesa de Otay" },
    { id: "SUP-03", name: "Taller Mecánico & Herrería Los Pinos", tier: "T2", phone: "664-555-0742", city: "Florido" },
    { id: "SUP-04", name: "Maquiladora Precision Metals S.A.", tier: "T3", phone: "664-555-0911", city: "Parque Ind. Otay" },
    { id: "SUP-05", name: "Pedro Soto (Recolector Independiente)", tier: "T1", phone: "664-555-0453", city: "Guaycura" }
  ],
  ...
  recentWeighings: [
    {
      ...
      supplierName: "Transportes y Fletes El Rayo",
      tier: "T2",
      materialId: "MAT-01",
      ...
      netWeightKg: 170.0,
      pricePerKg: 129.36,
      totalPayout: 21991.20,
      status: "PAGADO_EFECTIVO",
      scaleType: "Báscula Plataforma 1 Ton"
    },
    {
      folio: "REC-2026-0841",
      timestamp: "2026-09-03 13:40",
      supplierName: "Don Juan Martínez (Triciclo)",
      tier: "T1",
      materialId: "MAT-03",
    ...
    {
      folio: "REC-2026-0840",
      timestamp: "2026-09-03 12:05",
      supplierName: "Pedro Soto (Recolector Independiente)",
      tier: "T1",
      materialId: "MAT-05",
      materialName: "Aluminio Bote / Lata Prensada",
      grossWeightKg: 62.0,
      tareWeightKg: 4.0,
      netWeightKg: 58.0,
      pricePerKg: 20.88,
